...
export var ComparisonTypeEnum = (function (DataTypeEnum, PropertyTypeEnum) {
  ...
  function ComparisonType(
    ...
    label,
    alias,
    expectedNumberOfObjectValues,
    dataTypeRestrictionGroup,
    propertyTypeRestrictionGroup,
  ) {
  ...
  const dataTypeGroup = {
    // TODO: Collection type was added, not covered here
    ALL: [
      DataTypeEnum.STRING,
      DataTypeEnum.NUMBER,
  ...
  function EnumDefs() {
    ...
    this.EQUAL = new ComparisonType(
      "EQUAL",
      "Equal",
      "eq",
      1,
      dataTypeGroup.NON_OBJECT,
      PropertyTypeEnum.SINGLE,
    );
    this.NOT_EQUAL = new ComparisonType(
      "NOT_EQUAL",
      "Not Equal",
      "ne",
      1,
    ...
    this.GT = new ComparisonType(
      "GT",
      "Greater Than",
      "gt",
      1,
      dataTypeGroup.ORDERED,
      PropertyTypeEnum.SINGLE,
    );
    this.GTE = new ComparisonType(
      "GTE",
    ...
    this.BETWEEN = new ComparisonType(
      "BETWEEN",
      "Between",
      "between",
      2,
    ...
    this.NOT_BETWEEN = new ComparisonType(
      "NOT_BETWEEN",
      "Not Between",
      "notbetween",
      2,
    ...
    this.IN = new ComparisonType(
      "IN",
      "In",
      "in",
      10,
      dataTypeGroup.NON_BOOLEAN,
      PropertyTypeEnum.SINGLE,
    );
    this.NOT_IN = new ComparisonType(
      "NOT_IN",
      "Not In",
      "notin",
      10,
    ...
    this.IN_LIST = new ComparisonType(
      "IN_LIST",
      "In List",
      "inlist",
      1,
    ...
    this.NOT_IN_LIST = new ComparisonType(
      "NOT_IN_LIST",
      "Not In List",
      "notinlist",
      1,
    ...
    this.LIKE = new ComparisonType(
      "LIKE",
      "Like",
      "like",
      1,
      dataTypeGroup.STRING_AND_LOB,
      PropertyTypeEnum.SINGLE,
    );
    this.NOT_LIKE = new ComparisonType(
      "NOT_LIKE",
      "Not Like",
      "notlike",
      1,
    ...
    this.NOT_NULL = new ComparisonType(
      "NOT_NULL",
      "Is Not Null",
      "notnull",
      0,
    ...
    this.EMPTY = new ComparisonType(
      "EMPTY",
      "Is Empty",
      "empty",
      0,
      dataTypeGroup.OBJECT,
      PropertyTypeEnum.MULTI,
    );
    this.NOT_EMPTY = new ComparisonType(
      "NOT_EMPTY",
      "Is Not Empty",
      "notempty",
      0,
    ...
    this.getAllForDataType = (dataType, propertyType) => {
      const valueArray = [];
      for (const prop in this) {
        if (this.hasOwnProperty(prop)) {
          ...
          if (typeof item !== "function" && isDataTypeInGroup(dataType, item.dataTypeGroup)) {
            if (propertyType) {
              // Caller wants to restrict to propertyType
              if (isPropertyTypeInGroup(propertyType, item.propertyType)) {
                valueArray.push(item);
              }
            } else {
              // Caller didn't specify propertyType to restrict on
              valueArray.push(item);
            }
          }
        }
