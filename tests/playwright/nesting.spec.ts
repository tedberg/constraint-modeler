...
test('Builds a nested constraint group with OR junction', async ({ page }) => {
  ...
  await firstConstraint.locator('[data-test="property-menu"] a.nav-link').click();
  await page.getByRole('menuitem', { name: /^Status$/ }).click();
  await firstConstraint.locator('[data-test="comparison-menu"] a.nav-link').click();
  ...
  await subGroup.locator('.constraint-group-bar a.nav-link').click();
  ...
  await nestedConstraint.locator('[data-test="property-menu"] a.nav-link').click();
  await page.getByRole('menuitem', { name: /^Age$/ }).click();
  await nestedConstraint.locator('[data-test="comparison-menu"] a.nav-link').click();
